...
class FlanModelForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'image_url' : forms.URLInput(attrs={'class':'form-control', 'placeholder':'http://www.dominio.cl/imagen.png', 'pattern': r'/.*\.png|.*\.jpeg|.*\.jpg|.*\.gif|.*\.webp/', 'title': 'Solo se aceptan archivos PNG, JPG y WEBP'}),
